...
import {onexAllProducts} from '../helpers/onexProducts';

const OnexCartItemComponent = ({item}) => {
  ...
  const productImage = onexAllProducts.find(p => p.name === item.name)?.image;
...
export default OnexCartItemComponent;
